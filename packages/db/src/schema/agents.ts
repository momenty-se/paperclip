...
export const agents = pgTable(
  "agents",
  {
    ...
    failoverChain: jsonb("failover_chain").$type<Record<string, unknown> | null>(),
    failoverCostMultiplierMax: integer("failover_cost_multiplier_max").notNull().default(3),
    failoverOptOut: boolean("failover_opt_out").notNull().default(false),
